  ...
  var e = "config",
    ...
    Gt = {
      ...
      extend: function (e, t) {
        ...
        Gt[n](t, function (n) {
          Gt[$](t[n])
            ? (Gt[$](e[n]) || (e[n] = []), Gt[X](e[n], t[n]))
            : typeof t[n] == b
            ? (typeof e[n] != b && (e[n] = {}), Gt[X](e[n], t[n]))
            : (e[n] = t[n]);
        });
      },
      getArray: function (e) {
      ...
      applyRowTransforms: function (t) {
        var r,
          i,
          o,
          u = Gt.getLevel(t[e][S][_t]);
        Gt[e].RTL && (Gt.unreverseRows(), u > 0 && Gt.reverseRows(u)),
          (i = "_skel_cell_important_placeholder"),
          (r = Gt[s]("skel-cell-important")),
          r &&
            r[f] > 0 &&
            Gt[n](r, function (t) {
              if (t === f) return;
      ...
      changeState: function (s) {
        ...
        if (!Gt[H][vt][Gt[r]]) {
          (Gt[H][vt][Gt[r]] = {
            ...
            (c = Gt[H][vt][Gt[r]]),
            Gt[r] === Gt.sd ? (u = []) : (u = Gt[r][_](1).split(Gt.sd)),
            Gt[X](c[e], Gt[it][x]),
            Gt[n](u, function (n) {
              Gt[X](c[e], Gt[t][u[n]][e]);
            }),
            ...
            c[e][P].content
              ? (T = c[e][P].content)
              : (c[e][P].scalable === a
                  ? p[d]("user-scalable=no")
                  : p[d]("user-scalable=yes"),
                c[e][P].width ? p[d]("width=" + c[e][P].width) : p[d](dt),
                (T = p.join(","))),
            (g = Gt[m](b)) || (g = Gt[w](b, Gt.newMeta(P, T), Z, 4)),
            c[i][d](g);
          var k, L;
          (p = Gt[C](c[e][I])),
            (k = p[0]),
              ...
              (g = Gt[w](
                ...
                Gt[E](
                  "body{min-width:" +
                    ...
                    A +
                    j +
                    ".container.large{width:100%;max-width:" +
                    D +
                    ";min-width:" +
                    O +
                    j
              ...
              (g = Gt[w](
                ...
                Gt[E](
                  ".row>*{padding-left:" +
                    ...
                    J +
                    j +
                    ".row+.row.uniform.quarter>*{padding:" +
                    J +
                    v +
                    J +
                    j +
                    ...
                    G +
                    j +
                    ".row+.row.uniform.oneandhalf>*{padding:" +
                    G +
                    v +
                    G +
                    j +
                    ...
                    Y +
                    j +
                    ".row+.row.uniform.double>*{padding:" +
                    Y +
                    v +
                    Y +
                    j
          ...
          if (c[e][S][_t]) {
            ...
            if (!(g = Gt[m](b))) {
              ...
              switch (ht) {
                ...
                case 1:
                  T +=
                    ":not(.collapse-at-4):not(.collapse-at-3):not(.collapse-at-2)";
              }
              (p = Gt[C](c[e][S][h][kt])),
                (pt = p[0] + p[1]),
                (p = Gt[C](c[e][S][h][at])),
          ...
          Gt[n](u, function (r) {
            Gt[t][u[r]][e][Qt] &&
              ((b = "ss" + u[r]),
              (g = Gt[m](b)) ||
                (g = Gt[w](b, Gt.newStyleSheet(Gt[t][u[r]][e][Qt]), F, 5)),
              c[i][d](g)),
              Gt[t][u[r]][i][f] > 0 &&
                Gt[n](Gt[t][u[r]][i], function (e) {
                  c[i][d](Gt[t][u[r]][i][e]);
                });
          }),
            Gt[H][o][Gt[r]] &&
              (Gt[n](Gt[H][o][Gt[r]], function (e) {
                c[i][d](Gt[H][o][Gt[r]][e]);
              }),
              (Gt[H][o][Gt[r]] = []));
        } else c = Gt[H][vt][Gt[r]];
        Gt.detachAllElements(c[i]),
          Gt[ut](c[i]),
          Gt[Q](function () {
            Gt[Nt](c);
          }),
          (Gt[q].state = Gt[H][vt][Gt[r]]),
          (Gt[q][r] = Gt[r]),
          Gt.trigger(At);
      },
      getStateId: function () {
      ...
      poll: function () {
        ...
        (e = Gt.getStateId()),
          ...
          e !== Gt[r] &&
            (Gt[Kt]
              ? Gt.changeState(e)
              : ((Gt[N][Mt][g] = Gt[N][Mt][g][U](
                  Gt[r][_](1)[U](new RegExp(Gt.sd, "g"), " "),
                  ""
                )),
                Gt.changeState(e),
                (Gt[N][Mt][g] =
      ...
      updateState: function () {
        ...
        (e = Gt[r][_](1).split(Gt.sd)),
          ...
          Gt[H][o][Gt[r]] &&
            (Gt[n](Gt[H][o][Gt[r]], function (e) {
              Gt[H][vt][Gt[r]][i][d](Gt[H][o][Gt[r]][e]),
                l[d](Gt[H][o][Gt[r]][e]);
            }),
            (Gt[H][o][Gt[r]] = [])),
          l[f] > 0 && Gt[ut](l);
      ...
      init: function (t, r) {
        Gt.initConfig(t),
          ...
          Gt.initEvents(),
          Gt.poll(),
          r && typeof r == b && (Gt[e][ft] = r),
          Gt[n](Gt[ft], function (t) {
      ...
      initAPI: function () {
        ...
        (Gt[q][ot] = 99),
          ...
          r[L](/Firefox/)
            ...
            : r[L](/Chrome/)
            ? (e = "chrome")
            : r[L](/Safari/) && !r[L](/Chrome/)
            ? (e = "safari")
            : r[L](/(OPR|Opera)/)
            ? (e = "opera")
            : r[L](/MSIE ([0-9]+)/)
            ? ((e = "ie"), (Gt[q][ot] = RegExp.$1))
            : r[L](/Trident\/.+rv:([0-9]+)/) &&
              ((e = "ie"), (Gt[q][ot] = RegExp.$1)),
          (Gt[q].browser = e),
          (Gt[q][O] = "other"),
        ...
        (Gt[q].deviceVersion = e),
          (Gt[q].isTouch =
            Gt[q][O] == "wp"
              ? navigator.msMaxTouchPoints > 0
              : "ontouchstart" in window),
          (Gt[q].isMobile =
            Gt[q][O] == "wp" || Gt[q][O] == Wt || Gt[q][O] == "ios");
      },
      initConfig: function (r) {
        var s = [],
          o = [];
        typeof r == b && (r[t] && (Gt[e][t] = {}), Gt[X](Gt[e], r)),
          S in Gt[e] &&
            h in Gt[e][S] &&
            typeof Gt[e][S][h] != b &&
            (Gt[e][S][h] = {
          ...
          Gt[X](Gt[it][x][S], Gt[e][S]),
          (Gt[it][x][I] = Gt[e][I]),
          Gt[n](Gt[e][t], function (n) {
            var r,
              s = {},
              u,
              a;
            Gt[X](s, Gt[e][t][n]),
              Qt in s || (s[Qt] = Gt[it][x][Qt]),
              Tt in s || (s[Tt] = Gt[it][x][Tt]),
              "range" in s &&
                ((u = s.range),
                u == "*"
                  ? (a = "")
                  : u.charAt(0) == "-"
                  ? (a = "(max-width: " + parseInt(u[_](1)) + "px)")
                  : u.charAt(u[f] - 1) == "-"
                  ? (a = Et + parseInt(u[_](0, u[f] - 1)) + "px)")
                  : Gt[R](u, "-") != -1 &&
                    ((u = u.split("-")),
                    (a =
                      Et +
              ...
              (Gt[e][t][n] = s),
              (r = {}),
              Gt[X](r, Gt[it].breakpoint),
              (r[e] = Gt[e][t][n]),
              (r.test = function () {
                return Gt[W](s[Tt]);
              }),
              (r[i] = []),
              Gt[e].preload && r[e][Qt] && o[d](r[e][Qt]),
              (Gt[t][n] = r),
              Gt.breakpointList[d](n);
          }),
          "*" in Gt[e][t] && ((Gt[Kt] = D), (Gt[e][t]["*"][P] = Gt[e][P])),
          Gt[n](Gt[e][V], function (t) {
            Gt.bind(t, Gt[e][V][t]);
          }),
          o[f] > 0 &&
      ...
      initElements: function () {
        ...
        t[d](Gt[A]("iBM", Gt[E](Gt.css.bm), Z, 1)),
          t[d](
            Gt[A](
              "iG",
              Gt[E](
      ...
      initEvents: function () {
        ...
        !Gt[e].pollOnce &&
          ...
          window[Jt] && Gt.bind(xt, window[Jt]),
          (window[Jt] = function () {
            Gt.trigger(xt);
          }),
          window[J] && Gt.bind(T, window[J]),
          (window[J] = function () {
            Gt.trigger(T);
          });
      },
          ...
          window.matchMedia
            ...
            ? (Gt[W] = function (e) {
                ...
                (t.type = ht),
                  ...
                  n[l][p](t, n),
                  (r = (G in window && window[G](t, c)) || t.currentStyle);
                var i =
      ...
      preInit: function () {
        ...
        (Gt.me = e[e[f] - 1]),
          Gt.initUtilityMethods(),
          Gt.initAPI(),
          Gt[nt](Mt, document[u](Mt)[0]),
          Gt[nt](F, document[u](F)[0]),
          Gt[Q](function () {
          ...
          Gt[q][ot] >= 10 &&
            Gt[lt](
              Gt[A](
                "msie-viewport-fix",
                Gt[E]("@-ms-viewport{width:device-width;}"),
                Z,
                1
              )
            );
